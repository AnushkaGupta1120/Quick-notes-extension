...
function createToolbar() {
  ...
  bar.style.background = "rgba(15, 23, 42, 0.55)";
  bar.style.backdropFilter = "blur(22px)";
  bar.style.border = "1px solid rgba(148, 163, 184, 0.28)";
  bar.style.boxShadow = "0 18px 50px rgba(0,0,0,0.70)";
  ...
  bar.onmouseenter = () => {
    ...
    bar.style.boxShadow = "0 22px 65px rgba(0,0,0,0.85)";
  ...
  function hoverEffect(btn) {
    btn.onmouseenter = () => {
      ...
      btn.style.boxShadow = "0 12px 28px rgba(37,99,235,0.6)";
    };
    btn.onmouseleave = () => {
      btn.style.background = "rgba(15,23,42,0.45)";
...
function showFloatingButton() {
  ...
  btn.style.backdropFilter = "blur(22px)";
  btn.style.border = "1px solid rgba(148,163,184,0.35)";
  btn.style.boxShadow = "0 18px 50px rgba(0,0,0,0.8)";
  btn.style.cursor = "pointer";
...
function toggleNotesList() {
  ...
  nonEmptyNotes.slice().reverse().forEach((n) => {
...
function createNoteElement(note, show = false) {
  ...
  wrap.style.backdropFilter = "blur(22px)";
  wrap.style.border = "1px solid rgba(148,163,184,0.28)";
  wrap.style.borderRadius = "14px";
  wrap.style.display = show ? "flex" : "none";
  wrap.style.flexDirection = "column";
  wrap.style.boxShadow = "0 20px 55px rgba(0,0,0,0.6)";
